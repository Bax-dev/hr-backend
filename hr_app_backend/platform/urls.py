...
from .views import (
    ...
    integrations_view,
    inventory_view,
    bulk_notification_status_view,
    bulk_notification_view,
...
urlpatterns = [
    ...
    path('notifications/bulk/', bulk_notification_view, name='bulk-notification'),
    path('notifications/bulk/<uuid:campaign_pk>/', bulk_notification_status_view, name='bulk-notification-status'),
    ...
    path('inventory/<uuid:record_pk>/', communication_detail_view, {'module': 'inventory'}, name='inventory-detail'),
