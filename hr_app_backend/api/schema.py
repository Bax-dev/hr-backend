...
PUBLIC_PATHS = {
    ...
    "/api/v1/auth/employee-invite/",
    "/api/v1/auth/employee-invite/accept/",
    "/api/v1/billing/signup/initialize/",
    "/api/v1/billing/signup/verify/",
...
USED_OPERATIONS = {
    ...
    "/api/v1/ai/assistant/": {"post"},
    "/api/v1/auth/account/": {"delete"},
    "/api/v1/auth/change-password/": {"post"},
    "/api/v1/auth/employee-invite/": {"get"},
    "/api/v1/auth/employee-invite/accept/": {"post"},
    "/api/v1/auth/forgot-password/": {"post"},
    "/api/v1/auth/login/": {"post"},
    "/api/v1/auth/logout/": {"post"},
    "/api/v1/auth/me/": {"get", "patch"},
    "/api/v1/auth/resend-signup-otp/": {"post"},
    "/api/v1/auth/reset-password/": {"post"},
    "/api/v1/auth/signup/company/": {"post"},
    "/api/v1/auth/verify-signup-otp/": {"post"},
    "/api/v1/billing/signup/initialize/": {"post"},
    "/api/v1/billing/signup/verify/": {"post"},
    "/api/v1/billing/subscriptions/initialize/": {"post"},
    "/api/v1/billing/subscriptions/verify/": {"post"},
    ...
    "/api/v1/files/folders/{folder_pk}/shares/": {"get", "post"},
    "/api/v1/files/folders/{folder_pk}/shares/{share_pk}/": {"delete"},
    "/api/v1/files/presign/": {"post"},
    "/api/v1/files/search/": {"get"},
    ...
    "/api/v1/inventory/{record_pk}/": {"patch", "delete"},
    ...
    "/api/v1/superadmin/companies/": {"get"},
    "/api/v1/superadmin/companies/{org_id}/": {"get"},
    "/api/v1/superadmin/companies/{org_id}/status/": {"patch"},
    "/api/v1/superadmin/dashboard/": {"get"},
    "/api/v1/superadmin/notifications/campaigns/": {"get", "post"},
    "/api/v1/superadmin/plans/": {"get"},
    "/api/v1/superadmin/records/archived/": {"get"},
    "/api/v1/superadmin/records/employees/": {"get"},
    "/api/v1/superadmin/subscriptions/": {"get"},
    "/api/v1/superadmin/users/": {"get"},
    "/api/v1/uploads/presign/": {"post"},
    "/api/v1/uploads/files/{key}/": {"get"},
}
